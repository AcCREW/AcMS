<div data-ng-controller="Membership" id="Membership" data-ng-enter="Membership">
    ...
    <div class="right">
        <input type="text" id="login_username" class="login_input" placeholder="Username..." data-ng-model="_this.Username"/>
    </div>
    <div class="clear"></div>
    <div class="left" style="margin-top: 10px">
    ...
    <div class="right">
        <input type="password" id="login_password" class="login_input" placeholder="Password..." data-ng-model="_this.Password" />
    </div>
    <div class="clear"></div>
    <div class="left">
        <input type="checkbox" id="login_remember_me" class="left" data-ng-model="_this.RememberMe" />
